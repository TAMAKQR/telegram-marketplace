            ...
            <div className="max-w-6xl mx-auto px-6 py-12">
                ...
                <section className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl p-12 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a href="https://t.me/romashkacz_bot" className="bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg transition-shadow">
                            🤖 Открыть бота
                        </a>
                        <a href="https://t.me/rosmashkacz" className="bg-white bg-opacity-20 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-opacity-30 transition-colors">
                            💬 Наш канал
                        </a>
                    </div>
