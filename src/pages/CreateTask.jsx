        ...
        <div className="min-h-screen pb-6 overflow-x-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4 max-w-full">
                ...
                <div>
                    ...
                    />
                    <p className="text-xs text-tg-hint mt-1">
                        ⏱️ Сколько дней после отправки/принятия отчёта система будет считать прирост метрик и обновлять прогресс
                    </p>
                </div>
                ...
                <div>
                    ...
                    />
                    <p className="text-xs text-tg-hint mt-1">
                        📅 До этой даты исполнитель должен отправить ссылку/отчёт. После этого метрики отслеживаются ещё {parseInt(formData.metricDeadlineDays, 10) || 7} дн.
                    </p>
                </div>
