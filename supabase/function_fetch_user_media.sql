...
BEGIN
    ...
    v_url := 'https://graph.instagram.com/v22.0/' || p_instagram_user_id || '/media?fields=id,caption,media_type,media_url,thumbnail_url,permalink,timestamp,like_count,comments_count&limit=' || p_limit::TEXT || '&access_token=' || p_access_token;
